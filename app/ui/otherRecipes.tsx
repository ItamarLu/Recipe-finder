    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
      {
        ...
        <div key={recipe.title} className="py-5 px-5 flex flex-col gap-2 bg-gradient-to-br from-red-500 to-orange-500 rounded-md max-h-96 overflow-y-auto custom-scrollbar relative">
